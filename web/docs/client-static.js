...
$$.LinkIterator = {"": "Object;_liblib5$_current,_link",
  ...
  moveNext$0: function() {
    ...
    t1 = this._link;
    this._liblib5$_current = t1.get$head(t1);
...
$.json = function() {
  return [$.makeLiteralMap(["name", "metadata", "types", [$.makeLiteralMap(["name", "DocsEditable", "kind", "class"]), $.makeLiteralMap(["name", "DomName", "kind", "class", "members", [$.makeLiteralMap(["kind", "constructor", "name", "DomName"]), $.makeLiteralMap(["kind", "field", "name", "name"])]]), $.makeLiteralMap(["name", "Experimental", "kind", "class"]), $.makeLiteralMap(["name", "SupportedBrowser", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "browserName"]), $.makeLiteralMap(["kind", "field", "name", "CHROME"]), $.makeLiteralMap(["kind", "field", "name", "FIREFOX"]), $.makeLiteralMap(["kind", "field", "name", "IE"]), $.makeLiteralMap(["kind", "field", "name", "minimumVersion"]), $.makeLiteralMap(["kind", "field", "name", "OPERA"]), $.makeLiteralMap(["kind", "field", "name", "SAFARI"]), $.makeLiteralMap(["kind", "constructor", "name", "SupportedBrowser"])]])]]), $.makeLiteralMap(["name", "wimmel", "members", [$.makeLiteralMap(["kind", "method", "name", "into4"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "main"])], "types", [$.makeLiteralMap(["name", "Camera", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "ax"]), $.makeLiteralMap(["kind", "field", "name", "ay"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "borders"]), $.makeLiteralMap(["kind", "constructor", "name", "Camera"]), $.makeLiteralMap(["kind", "field", "name", "height"]), $.makeLiteralMap(["kind", "method", "name", "move"]), $.makeLiteralMap(["kind", "method", "name", "update"]), $.makeLiteralMap(["kind", "field", "name", "width"]), $.makeLiteralMap(["kind", "field", "name", "x"]), $.makeLiteralMap(["kind", "field", "name", "y"])]]), $.makeLiteralMap(["name", "Car", "kind", "class", "members", [$.makeLiteralMap(["kind", "constructor", "noparams", true, "name", "Car"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "degrees"]), $.makeLiteralMap(["kind", "field", "name", "goal"]), $.makeLiteralMap(["kind", "field", "name", "point"]), $.makeLiteralMap(["kind", "field", "name", "pos"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "rotation"]), $.makeLiteralMap(["kind", "field", "name", "segment"]), $.makeLiteralMap(["kind", "method", "name", "update"])]]), $.makeLiteralMap(["name", "Game", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "noparams", true, "name", "begin"]), $.makeLiteralMap(["kind", "field", "name", "camera"]), $.makeLiteralMap(["kind", "field", "name", "canvas"]), $.makeLiteralMap(["kind", "field", "name", "context"]), $.makeLiteralMap(["kind", "field", "name", "delta"]), $.makeLiteralMap(["kind", "constructor", "name", "Game"]), $.makeLiteralMap(["kind", "field", "name", "images"]), $.makeLiteralMap(["kind", "method", "name", "loop"]), $.makeLiteralMap(["kind", "field", "name", "map"]), $.makeLiteralMap(["kind", "field", "name", "MAPHEIGHT"]), $.makeLiteralMap(["kind", "field", "name", "MAPRENDER"]), $.makeLiteralMap(["kind", "field", "name", "MAPWIDTH"]), $.makeLiteralMap(["kind", "field", "name", "maus"]), $.makeLiteralMap(["kind", "method", "name", "mouseDown"]), $.makeLiteralMap(["kind", "method", "name", "mouseMove"]), $.makeLiteralMap(["kind", "method", "name", "mouseUp"]), $.makeLiteralMap(["kind", "field", "name", "pause"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "request"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "resize"]), $.makeLiteralMap(["kind", "field", "name", "resources"]), $.makeLiteralMap(["kind", "field", "name", "run"]), $.makeLiteralMap(["kind", "field", "name", "SCREENHEIGHT"]), $.makeLiteralMap(["kind", "field", "name", "SCREENWIDTH"]), $.makeLiteralMap(["kind", "field", "name", "shiftdown"]), $.makeLiteralMap(["kind", "field", "name", "start"]), $.makeLiteralMap(["kind", "field", "name", "testcar"])]]), $.makeLiteralMap(["name", "Json", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "data"]), $.makeLiteralMap(["kind", "constructor", "name", "Json"]), $.makeLiteralMap(["kind", "field", "name", "manager"]), $.makeLiteralMap(["kind", "method", "name", "onDataLoaded"])]]), $.makeLiteralMap(["name", "Maus", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "pressed"]), $.makeLiteralMap(["kind", "field", "name", "x"]), $.makeLiteralMap(["kind", "field", "name", "y"])]]), $.makeLiteralMap(["name", "Object", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "error"]), $.makeLiteralMap(["kind", "field", "name", "image"]), $.makeLiteralMap(["kind", "field", "name", "manager"]), $.makeLiteralMap(["kind", "constructor", "name", "Object"]), $.makeLiteralMap(["kind", "method", "name", "onerror"]), $.makeLiteralMap(["kind", "method", "name", "onload"])]]), $.makeLiteralMap(["name", "ResourceManager", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "noparams", true, "name", "checkNotify"]), $.makeLiteralMap(["kind", "field", "name", "loading"]), $.makeLiteralMap(["kind", "field", "name", "notify"]), $.makeLiteralMap(["kind", "field", "name", "notifyFunction"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "registerFinished"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "registerLoading"]), $.makeLiteralMap(["kind", "method", "name", "registerNotifyFunction"])]]), $.makeLiteralMap(["name", "Tile", "kind", "class", "members", [$.makeLiteralMap(["kind", "field", "name", "error"]), $.makeLiteralMap(["kind", "field", "name", "image"]), $.makeLiteralMap(["kind", "field", "name", "manager"]), $.makeLiteralMap(["kind", "method", "name", "onerror"]), $.makeLiteralMap(["kind", "method", "name", "onload"]), $.makeLiteralMap(["kind", "constructor", "name", "Tile"])]])]])];
};
